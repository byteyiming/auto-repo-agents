...
export const languages: Language[] = ['en', 'zh', 'ja', 'ko', 'es'];
...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'documents.view.category': 'By Category',
    'documents.view.level': 'By Level',
    'documents.recommend': 'Recommended',
    'documents.recommend.tooltip': 'These documents are recommended because they are dependencies of your selected documents',
    'documents.templates': 'Document Templates',
    'documents.templates.select': 'Select a template',
    'documents.templates.apply': 'Apply Template',
    'documents.templates.clear': 'Clear Selection',
    'documents.templates.description': 'Pre-configured document combinations for different roles',
    ...
    'error.boundary.message': 'We encountered an unexpected error. Please try again.',
    'error.boundary.retry': 'Try Again',
    'error.boundary.home': 'Go Home',
    'project.idea.chars': 'characters',
    ...
    'status.improvementCompleted': 'Improvement completed',
  ...
  zh: {
    ...
    'documents.view.category': '按分类',
    'documents.view.level': '按级别',
    'documents.recommend': '推荐',
    'documents.recommend.tooltip': '这些文档被推荐，因为它们是您已选择文档的依赖项',
    'documents.templates': '文档模板',
    'documents.templates.select': '选择模板',
    'documents.templates.apply': '应用模板',
    'documents.templates.clear': '清除选择',
    'documents.templates.description': '针对不同角色的预配置文档组合',
    ...
    'status.reviewCompleted': '审查完成',
    'status.improving': '改进中',
    'status.improvementCompleted': '改进完成',
  ...
  ja: {
    ...
    'documents.view.category': 'カテゴリ別',
    'documents.view.level': 'レベル別',
    'documents.recommend': '推奨',
    'documents.recommend.tooltip': 'これらのドキュメントは、選択したドキュメントの依存関係であるため推奨されます',
    'documents.templates': 'ドキュメントテンプレート',
    'documents.templates.select': 'テンプレートを選択',
    'documents.templates.apply': 'テンプレートを適用',
    'documents.templates.clear': '選択をクリア',
    'documents.templates.description': '異なる役割向けの事前設定されたドキュメント組み合わせ',
  ...
  ko: {
    ...
    'documents.view.category': '카테고리별',
    'documents.view.level': '레벨별',
    'documents.recommend': '추천',
    'documents.recommend.tooltip': '이 문서들은 선택한 문서의 종속성이므로 추천됩니다',
    'documents.templates': '문서 템플릿',
    'documents.templates.select': '템플릿 선택',
    'documents.templates.apply': '템플릿 적용',
    'documents.templates.clear': '선택 지우기',
    'documents.templates.description': '다양한 역할에 맞는 사전 구성된 문서 조합',
  ...
  es: {
    'app.title': 'OmniDoc 2.0',
    'app.subtitle': 'Sistema de generación de documentación impulsado por IA',
    'project.idea': 'Idea del Proyecto',
    'project.idea.placeholder': 'Describe tu idea de proyecto en detalle...',
    'project.idea.description': 'Proporciona una descripción detallada de tu proyecto. Cuantos más detalles incluyas, mejor será la documentación generada.',
    'project.idea.tips.title': 'Consejos para Escribir una Gran Idea de Proyecto',
    'project.idea.tips.1': 'Describe el problema central que resuelve tu proyecto',
    'project.idea.tips.2': 'Incluye usuarios objetivo y sus necesidades',
    'project.idea.tips.3': 'Menciona características y funcionalidades clave',
    'project.idea.tips.4': 'Agrega requisitos técnicos o restricciones si los hay',
    'documents.title': 'Seleccionar Documentos',
    'documents.team': 'Vista de Equipo',
    'documents.solo': 'Vista Individual',
    'documents.all': 'Todos los Documentos',
    'documents.select': 'Seleccionar Documentos para Generar',
    'documents.selected': 'Seleccionados',
    'documents.dependencies': 'Dependencias',
    'documents.view.category': 'Por Categoría',
    'documents.view.level': 'Por Nivel',
    'documents.recommend': 'Recomendado',
    'documents.recommend.tooltip': 'Estos documentos se recomiendan porque son dependencias de los documentos seleccionados',
    'documents.templates': 'Plantillas de Documentos',
    'documents.templates.select': 'Seleccionar plantilla',
    'documents.templates.apply': 'Aplicar Plantilla',
    'documents.templates.clear': 'Limpiar Selección',
    'documents.templates.description': 'Combinaciones de documentos preconfiguradas para diferentes roles',
    'documents.priority.high': 'Alta Prioridad',
    'documents.priority.medium': 'Prioridad Media',
    'documents.priority.low': 'Baja Prioridad',
    'documents.stage.mvp': 'MVP',
    'documents.stage.iteration': 'Post-MVP',
    'documents.audience.team': 'Equipo',
    'documents.audience.solo': 'Individual',
    'documents.audience.mixed': 'Mixto',
    'button.generate': 'Generar Documentos',
    'button.send': 'Enviar',
    'button.creating': 'Creando Proyecto...',
    'button.viewResults': 'Ver Resultados',
    'error.network': 'Error de Red',
    'error.loadDocuments': 'Error al cargar documentos',
    'error.createProject': 'Error al crear proyecto',
    'status.title': 'Estado del Proyecto',
    'status.connected': 'Actualizaciones en tiempo real conectadas',
    'status.polling': 'Sondeando actualizaciones (WebSocket no disponible)',
    'status.loading': 'Cargando estado del proyecto...',
    'status.waiting': 'Esperando actualizaciones de progreso...',
    'status.progress': 'Progreso',
    'status.completed': 'completado',
    'status.generationStarted': 'Generación iniciada',
    'status.planning': 'Planificando',
    'status.generating': 'Generando',
    'status.allDone': '¡Todo listo! Generados',
    'status.documents': 'documentos',
    'status.error': 'Error',
    'status.projectId': 'ID del Proyecto',
    'results.title': 'Documentos Generados',
    'results.share': 'Compartir',
    'results.copied': '¡Copiado!',
    'results.backToStatus': '← Volver al Estado',
    'results.newProject': 'Nuevo Proyecto',
    'results.noDocuments': 'Aún no se han generado documentos',
    'results.stillGenerating': 'Los documentos pueden estar generándose aún. Vuelve a verificar en un momento.',
    'results.viewStatus': 'Ver Estado',
    'results.loading': 'Cargando documentos...',
    'results.errorLoading': 'Error al cargar documentos',
    'results.shareTitle': 'Documentos Generados por OmniDoc',
    'results.shareText': 'Consulta estos documentos de proyecto generados',
    'level.strategic': 'Nivel 1: Estratégico (Emprendedor/CEO)',
    'level.product': 'Nivel 2: Gerente de Producto',
    'level.developer': 'Nivel 3: Desarrollador/Técnico',
    'level.user': 'Nivel 4: Usuario/Usuario Final',
    'level.operations': 'Nivel 5: Operaciones/Mantenimiento',
    'level.crossLevel': 'Nivel Cruzado (Todos)',
    'hero.title': 'De la Idea a la Documentación Completa en Minutos',
    'hero.subtitle': 'Sistema de generación de documentación impulsado por IA que crea documentos de proyecto completos a partir de una sola idea',
    'hero.description': 'Transforma tu idea de proyecto en un conjunto completo de documentación con nuestro sistema de IA multiagente',
    'hero.flow.idea': 'Idea',
    'hero.flow.agents': 'Agentes Personalizados',
    'hero.flow.documents': 'Documentos',
    'howItWorks.title': 'Cómo Funciona',
    'howItWorks.step1.title': 'Envía Tu Idea',
    'howItWorks.step1.description': 'Describe tu idea de proyecto en detalle',
    'howItWorks.step2.title': 'Selecciona Documentos',
    'howItWorks.step2.description': 'Elige qué documentos generar',
    'howItWorks.step3.title': 'Los Agentes Personalizados Trabajan',
    'howItWorks.step3.description': 'Los agentes personalizados generan tus documentos',
    'howItWorks.step4.title': 'Ver y Descargar',
    'howItWorks.step4.description': 'Accede a tu conjunto completo de documentación',
    // Document names (Spanish)
    'doc.name.requirements': 'Documento de Requisitos',
    'doc.name.requirements_analyst': 'Documento de Requisitos',
    'doc.name.project_charter': 'Carta del Proyecto',
    'doc.name.business_model': 'Modelo de Negocio',
    'doc.name.marketing_plan': 'Plan de Marketing',
    'doc.name.gtm_strategy': 'Estrategia GTM',
    'doc.name.stakeholders_doc': 'Documento de Interesados',
    'doc.name.stakeholder_communication': 'Comunicación con Interesados',
    'doc.name.risk_management_plan': 'Plan de Gestión de Riesgos',
    'doc.name.change_management_plan': 'Plan de Gestión del Cambio',
    'doc.name.feature_roadmap': 'Hoja de Ruta de Funciones',
    'doc.name.pm_management_doc': 'Documento de Gestión PM',
    'doc.name.wbs': 'Estructura de Desglose del Trabajo',
    'doc.name.user_stories': 'Historias de Usuario',
    'doc.name.prd': 'Documento de Requisitos del Producto',
    'doc.name.fsd': 'Documento de Especificación Funcional',
    'doc.name.pm_documentation': 'Documentación PM',
    'doc.name.user_analytics': 'Análisis de Usuario',
    'doc.name.dashboard_metrics': 'Métricas del Panel',
    'doc.name.kpi_metrics_doc': 'Métricas KPI',
    'doc.name.release_notes': 'Notas de Lanzamiento',
    'doc.name.user_feedback_plan': 'Plan de Retroalimentación del Usuario',
    'doc.name.ab_testing_docs': 'Documentos de Pruebas A/B',
    'doc.name.onboarding_flow': 'Flujo de Incorporación',
    'doc.name.interaction_flows': 'Flujos de Interacción',
    'doc.name.ui_mockups': 'Maquetas UI',
    'doc.name.ui_style_guide': 'Guía de Estilo UI',
    'doc.name.technical_documentation': 'Documentación Técnica',
    'doc.name.tad': 'Documento de Arquitectura Técnica',
    'doc.name.api_documentation': 'Documentación API',
    'doc.name.database_schema': 'Esquema de Base de Datos',
    'doc.name.developer_guide': 'Guía del Desarrollador',
    'doc.name.developer_documentation': 'Documentación del Desarrollador',
    'doc.name.setup_guide': 'Guía de Configuración',
    'doc.name.test_plan': 'Plan de Pruebas',
    'doc.name.test_documentation': 'Documentación de Pruebas',
    'doc.name.cicd_doc': 'Documentación CI/CD',
    'doc.name.api_versioning_policy': 'Política de Versionado de API',
    'doc.name.configuration_management_plan': 'Plan de Gestión de Configuración',
    'doc.name.deployment_plan': 'Plan de Despliegue',
    'doc.name.scalability_plan': 'Plan de Escalabilidad',
    'doc.name.technical_debt_log': 'Registro de Deuda Técnica',
    'doc.name.third_party_integrations': 'Integraciones de Terceros',
    'doc.name.feature_flag_docs': 'Documentos de Banderas de Función',
    'doc.name.user_documentation': 'Documentación de Usuario',
    'doc.name.user_support_doc': 'Documento de Soporte al Usuario',
    'doc.name.knowledge_base': 'Base de Conocimiento',
    'doc.name.support_training_doc': 'Documento de Capacitación de Soporte',
    'doc.name.backup_recovery_plan': 'Plan de Respaldo y Recuperación',
    'doc.name.maintenance_plan': 'Plan de Mantenimiento',
    'doc.name.monitoring_logging_plan': 'Plan de Monitoreo y Registro',
    'doc.name.performance_optimization_doc': 'Optimización de Rendimiento',
    'doc.name.cloud_infrastructure_doc': 'Documento de Infraestructura en la Nube',
    'doc.name.bcp': 'Plan de Continuidad del Negocio',
    'doc.name.sla': 'Acuerdo de Nivel de Servicio',
    'doc.name.vendor_management_docs': 'Documentos de Gestión de Proveedores',
    'doc.name.incident_response_plan': 'Plan de Respuesta a Incidentes',
    'doc.name.data_retention_policy': 'Política de Retención de Datos',
    'doc.name.data_governance_policy': 'Política de Gobernanza de Datos',
    'doc.name.security_plan': 'Plan de Seguridad',
    'doc.name.privacy_policy': 'Política de Privacidad',
    'doc.name.terms_of_service': 'Términos de Servicio',
    'doc.name.legal_compliance': 'Cumplimiento Legal',
    'doc.name.accessibility_plan': 'Plan de Accesibilidad',
    'doc.name.eol_policy': 'Política de Fin de Vida',
    'doc.name.localization_plan': 'Plan de Localización',
    'doc.name.technical_audit': 'Auditoría Técnica',
    'doc.name.support_playbook': 'Manual de Soporte',
    'doc.name.quality_review': 'Revisión de Calidad',
    'doc.name.document_improver': 'Mejorador de Documentos',
    'doc.name.format_converter': 'Convertidor de Formato',
    'doc.name.code_analyst': 'Analizador de Código',
  },
};
